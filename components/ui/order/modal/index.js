...
const createFormState = ({price, email, confirmationEmail}, hasAgreedTOS) => {
    ...
    return _createFormState({isDisabled: false});
}
                    ...
                    <div className="sm:flex sm:items-start">
                        <div className="mt-3 sm:mt-0 sm:ml-4 sm:text-left">
                            ...
                            <div className="mt-2 relative rounded-md">
                                ...
                                <input
                                    onChange={({target: {value}}) => setOrder({...order, email: value.trim()})}
                                    type="email"
                                    name="email"
                                    id="email"
                            ...
                            <div className="my-2 relative rounded-md">
                                ...
                                <input
                                    onChange={({target: {value}}) => setOrder({...order, confirmationEmail: value.trim()})}
                                    type="email"
                            ...
                            {formState.message &&
                                <div className={'p-4 my-3 text-red-700 bg-yellow-200 rounded-lg text-sm'}>
                                    {formState.message}
                                </div>}
                        </div>
                    </div>
